...
export class TapRepeatedly2UI extends BaseUI {
  ...
  constructor() {
    ...
    this.title = new PIXI.Text('Tap Repeatedly 2', { fontSize: 30, fontFamily: Fonts.UI, fill: Colors.TEXT });
  ...
  public onTick = () => {
    this.progressGauge.percent += this.speedGauge.percent * 0.005;
  ...
  private resetScene = () => {
    this.navForward(new TapRepeatedly2UI(), this.previousUI);
  }
